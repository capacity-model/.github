<h1 align="center">Supply Chain Facilities</h1>
...
<p align="center">
  <em>Instructor: Prof. Benoit Montreuil · Georgia Tech ISyE</em>
</p>
...
Every simulator runs in your browser — **nothing to install, just open the link**. Start by exploring the **parameters** and the **model formulas** shown on each page, then change one input at a time to build intuition.

## 🧪 Simulators

| Simulator | Web (HTML) | Python | Source code |
|---|:---:|:---:|:---:|
